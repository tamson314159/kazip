defmodule Kazip.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_password(changeset, opts) do
    ...
    |> validate_length(:password, min: 9, max: 72, message: "should be at least 9 character(s)")
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Kazip.Repo)
  ...
  """
  def valid_password?(%Kazip.Accounts.Account{hashed_password: hashed_password}, password)
