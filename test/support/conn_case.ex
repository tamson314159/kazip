defmodule KazipWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use KazipWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import KazipWeb.ConnCase
    end
  end

  setup tags do
    Kazip.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_account(%{conn: conn}) do
    account = Kazip.AccountsFixtures.account_fixture()
  ...
  def log_in_account(conn, account) do
    token = Kazip.Accounts.generate_account_session_token(account)
